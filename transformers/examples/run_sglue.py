...
def main():
    ...
    parser.add_argument(
        "--data_size", default=None, type=int, help="Data_size for Shapley Training (None for full data), e.g., 100 for debug ",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--is_baseline_run", action="store_true", help="Is the baseline run to get result, data_size, random/init score",
    )
    parser.add_argument(
