...
try:
    ...
    if not n_points:
        ...
        if 'full_training' in train_output_dir:
            command = train_run_command_full + ' --num_train_epochs ' + str(num_train_epochs) \
                      + ' --is_baseline_run --seed ' + str(seed) + ' '
        else:
    ...
    for iter_counter in trange(max_iter, desc='Overall Shpley Value Calculation'):
        ...
        if tmc_run:
            ...
            if error_ < err:
                ...
                if 'full_training' in train_output_dir:
                    mem_tmc, idxs_tmc = _tmc_shap(train_run_command_full + ' --num_train_epochs ' + str(num_train_epochs), \
